...
public class RobotContainer { // Subsystems
  ...
  public void updateDashboard() {
    ...
    // SmartDashboard.putData("WristL23Pos",
    ...
    // SmartDashboard.putData("WristAlgaePos",
    // wrist.setWristPosition(WristConstants.aglaeSetpoint));
    // SmartDashboard.putData(
    ...
    // SmartDashboard.putData("RampHomePos",
    // ramp.setRampPosition(RampConstants.coralStationSetpoint));
