...
public class ElevatorConstants {
  ...
  public static final double ELEVATOR_HOME_POSITION = 8.0;

  public static final double ELEVATOR_CORAL_PICKUP_POS = 8.0;
  public static final double ELEVATOR_ALGAE_PICKUP_FLOOR_POS = 8.0;
  ...
  public static final double ELEVAOTR_SCORE_CORAL_L1_POS = 8.0;
