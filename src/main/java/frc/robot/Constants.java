...
public final class Constants {
  ...
  public static final class TrolleyConstants {
    ...
    public static final double TROLLEY_SHOOTING_POSITION =
        1.10; // Also the farthest back it can be when the wrist is up. Flutters up to 1.2.
    ...
    public static final double TROLLEY_IN_OUT_THRESHOLD =
        1.16; // Can use this to decide if it's in or out
  ...
  public static final class PivotConstants {
    ...
    public static final double MIN_INPUT = -1.0;
    public static final double MAX_INPUT = 1.0;
    public static final double PIVOT_MIN_DOWN =
        0.245; // This is the lowest point the "head" can be down (the head is the intake)
